...
def test_psycopg_disables_prepared_statements_for_transaction_poolers(monkeypatch) -> None:
    ...
    monkeypatch.setattr(database_module, "async_sessionmaker", lambda *args, **kwargs: object())
...
def test_sqlite_keeps_default_connection_arguments(monkeypatch) -> None:
    captured: dict[str, Any] = {}
    engine = object()
